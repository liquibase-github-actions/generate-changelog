...
ANALYTICSCONFIGCACHETIMEOUTMILLIS=${30}
ANALYTICSCONFIGENDPOINTTIMEOUTMILLIS=${31}
ANALYTICSCONFIGENDPOINTURL=${32}
ANALYTICSDEVOVERRIDE=${33}
ANALYTICSENABLED=${34}
ANALYTICSLICENSEKEYCHARS=${35}
ANALYTICSLOGLEVEL=${36}
ANALYTICSTIMEOUTMILLIS=${37}
AUTOREORG=${38}
CHANGELOGLOCKPOLLRATE=${39}
CHANGELOGLOCKWAITTIMEINMINUTES=${40}
CHANGELOGPARSEMODE=${41}
CHECKSCOMPATIBILITYENABLED=${42}
CLASSPATH=${43}
CONVERTDATATYPES=${44}
CUSTOMLOGDATAFILE=${45}
CUSTOMLOGDATAFREQUENCY=${46}
