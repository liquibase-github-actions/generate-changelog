...
SCHEMAS=${21}
URL=${22}
USEORREPLACEOPTION=${23}
USERNAME=${24}
# Global Options
ADDEMPTYMDCVALUES=${25}
ALLOWDUPLICATEDCHANGESETIDENTIFIERS=${26}
ALWAYSDROPINSTEADOFREPLACE=${27}
ALWAYSOVERRIDESTOREDLOGICSCHEMA=${28}
AUTOREORG=${29}
...
SEARCHPATH=${86}
SECUREPARSING=${87}
SHOULDGENERATEROLLBACKREPORT=${88}
SHOULDRUN=${89}
